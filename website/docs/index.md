...
- **Runs anywhere, not just your laptop** — 7 terminal backends: local, Docker, SSH, Daytona, Singularity, Modal, and Vercel Sandbox. Daytona, Modal, and Vercel offer serverless persistence-oriented workflows — your environment hibernates when idle, costing nearly nothing
